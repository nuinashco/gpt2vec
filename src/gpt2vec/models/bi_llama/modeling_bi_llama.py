...
class biLlamaPreTrainedModel(LlamaPreTrainedModel):
    config: biLlamaConfig



class biLlamaModel(biLlamaPreTrainedModel):
    def __init__(self, config: biLlamaConfig):
...
class biLlamaForCausalLM(biLlamaPreTrainedModel, GenerationMixin):
